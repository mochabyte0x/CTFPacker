...
def main():
    ...
    parser_stageless.add_argument("-o", "--output", type=str, help="Output path where the loader is gonna be saved.", required=True)
    ...
    if args.commands == "staged":
        ...
        if args.payload and args.ip_address and args.port and args.path:
            ...
            print(Colors.green("[i] Template selected.."))
